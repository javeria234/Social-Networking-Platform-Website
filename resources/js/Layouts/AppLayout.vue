<template>
    <div class="flex flex-col min-h-screen homepage" >
        <nav class="bg-black border-b border-gray-100 w-full fixed z-20">
                ...
                <div class="flex justify-between h-24">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:ml-10 sm:flex items-center">
                            <h1 class="subheading"> Social Networking Platform </h1>
                        </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:justify-end sm:ml-6 w-1/2">
                        ...
                        <div class="flex items-center ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex items-center text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-transparent transition duration-150 ease-in-out text-white">
        ...
        <div class="flex flex-wrap pt-16 sm:flex-nowrap">
            ...
            <!-- Page Content -->
            <main class="bg-gray-200 shadow rounded my-9 py-6 px-4 w-full sm:w-2/3 sm:mx-2 sm:my-9 md:mx-4 md:px-10 lg:mx-auto">
                <slot></slot>
            </main>
        </div>
