<template>
    <pages-layout>
        <template #title>
            <div class="flex flex-col items-center sm:flex-row sm:justify-between">
                ...
                <span class="text-gray-800 leading-tight text-lg capitalize mt-5 sm:mt-0">
                    <inertia-link :href="route('events.index')" class="underline hover:text-green-500">Events</inertia-link>
                </span>
            </div>
        </template>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <img :src="showImage() + props.event.image" alt="Article Image" class="w-full h-64 object-cover object-center">

            <div class="px-4 py-5 sm:px-6">

                <div class="flex flex-col items-left sm:flex-row sm:justify-between mb-2">
                    <div class="mr-2 flex items-end font-semibold text-lg text-red-500 leading-tight">{{ props.event.date_of_event }}</div>
                        AT
            ...
            <div class="warpper">
                ...
                <div class="panels">
                    ...
                    <div class="panel" id="two-panel">
                        ...
                        <img :src="showImage() + props.event.image" alt="Article Image" class="w-full h-64 object-cover object-center">
                        <div class="mr-2 flex items-end font-semibold text-lg text-red-500 leading-tight">{{ props.event.date_of_event }} At {{ props.event.time_start }}</div>
